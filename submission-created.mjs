...
A quick reminder of why we're building this. PAXO takes no commission. You'll pay one flat daily rate, only on the days you drive, and keep 100% of every fare and every tip.
...
paxoride.com`,
    html: wrap(`
      ...
      ${perks([
        ...
        'Referral rewards when we launch'
      ], 'Your founding driver benefits')}
      <p>A quick reminder of why we're building this. <strong style="color:#0B1F3A">PAXO takes no commission.</strong> You'll pay one flat daily rate, only on the days you drive, and keep 100% of every fare and every tip.</p>
